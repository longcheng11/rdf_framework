	...
	public static def main(args: Array[String]) {
		...
		finish for( p in Place.places()){
			at (p) async {
				...
				//print R1
				var opath:String="/data/RDF_Processing/data_1b/index2/lubm_q10/"+pn.toString()+".R1";
				...
				//print R2
				opath="/data/RDF_Processing/data_1b/index2/lubm_q10/"+pn.toString()+".R2";
