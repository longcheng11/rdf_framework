	...
	public static def main(args: Array[String]) {
		...
		finish for( p in Place.places()){
			at (p) async {
				...
				var ns:String;
				val s2="/data/RDF_Processing/data_1b/index2/lubm_q10/"+pn.toString()+".R1.gz";
				...
				val s3="/data/RDF_Processing/data_1b/index2/lubm_q10/"+pn.toString()+".R2.gz";
				lstring=gzRead(s3);
				len=lstring.length();
				start=0;
				end=0;
