	...
	public static def main(args: Array[String]) {
		...
		finish for( p in Place.places()){
			at (p) async {			
				...
				Console.OUT.println("place: "+pn+" "+f_counter_1+" "+f_counter_2);
			}  
		}	
		...
		finish for( p in Place.places()){
			at (p) async {
				...
				var T1_List1:ArrayList[Long]=new ArrayList[Long](rev(0));
				var T1_List2:ArrayList[Long]=new ArrayList[Long](rev(0));
				var T1_List3:ArrayList[Long]=new ArrayList[Long](rev(0));
				
				var T2_List1:ArrayList[Long]=new ArrayList[Long](rev(1));
				var T2_List2:ArrayList[Long]=new ArrayList[Long](rev(1));
				...
				for(i in 0..(N-1)){
					...
					for(var j:Int=0;j<s2;j++){
						T1_List1.add(T1_keys_receive(here.id)(i)(j));					
						T1_List2.add(T1_payload1_receive(here.id)(i)(j));
						T1_List3.add(T1_payload1_receive(here.id)(i)(j));
					}
				}
				pRoot(here.id).addChild(tmpNode);
				...
				for(i in 0..(N-1)){
					...
					for(var j:Int=0;j<s3;j++){
						T2_List1.add(T2_keys_receive(here.id)(i)(j));
						T2_List1.add(T2_payload_receive(here.id)(i)(j));							
					}
				}
				pRoot(here.id).addChild(tmpNode);						
			}
		...
		Console.OUT.println("Build 3rd-index Takes "+(join_e-join_s)+" ms");
