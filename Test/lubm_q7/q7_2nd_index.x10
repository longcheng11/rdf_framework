	...
	public static def main(args: Array[String]) {
		...
		finish for( p in Place.places()){
			at (p) async {
				...
				//processing R4  <4405 12940 ?b>
				keyString=12940.toString()+4405.toString();
				if(poRoot_e(here.id).hasChild(keyString)){
					R0_Node=poRoot_e(here.id).getChild(keyString);
					R0_tuple=R0_Node.getData();
				}
				else{				
					R0_tuple=new ArrayList[Long]();
		...
		finish for( p in Place.places()){
			at (p) async {
				...
				//print R1
				var opath:String="/data/RDF_Processing/data_1b/index2/lubm_q7/"+pn.toString()+".R1";
				...
				//print R2
				opath="/data/RDF_Processing/data_1b/index2/lubm_q7/"+pn.toString()+".R2";
				...
				//print R3
				opath="/data/RDF_Processing/data_1b/index2/lubm_q7/"+pn.toString()+".R3";
				OutFile=new File(opath);
				...
				//print R4
				opath="/data/RDF_Processing/data_1b/index2/lubm_q7/"+pn.toString()+".R4";
				OutFile=new File(opath);
