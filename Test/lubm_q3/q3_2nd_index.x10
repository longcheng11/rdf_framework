	...
	public static def main(args: Array[String]) {
		...
		finish for( p in Place.places()){
			at (p) async {
				...
				//process R1  <?a 20758 267>			
				var R0_tuple:ArrayList[Long];
				var R0_Node:poNode;
				var keyString:String=20758.toString()+267.toString();
				...
				//processing R2  <?a 11886 6909>
				keyString=11886.toString()+6909.toString();				
				if(poRoot(here.id).hasChild(keyString)){
					R0_Node=poRoot(here.id).getChild(keyString);
					R0_tuple=R0_Node.getData();
				}
		...
		finish for( p in Place.places()){
			at (p) async {
				...
				//print R1
				var opath:String="/data/RDF_Processing/data_1b/index2/lubm_q3/"+pn.toString()+".R1";
				...
				//print R2
				opath="/data/RDF_Processing/data_1b/index2/lubm_q3/"+pn.toString()+".R2";
