	...
	public static def main(args: Array[String]) {
			...
			at (p) async {	
				...
				if(pn==0){
					...
					for( k in (0..(N-1))) {
						...
						rev(4)+=R4_keys_receive(here.id)(k).size;
					}
		...
		finish for( p in Place.places()){
			at (p) async {
				...
				//print R1
				var opath:String="/data/RDF_Processing/data_1b/index2/lubm_q8/"+pn.toString()+".R1";
				...
				//print R2
				opath="/data/RDF_Processing/data_1b/index2/lubm_q8/"+pn.toString()+".R2";
				...
				//print R3
				opath="/data/RDF_Processing/data_1b/index2/lubm_q8/"+pn.toString()+".R3";
				OutFile=new File(opath);
				...
				//print R4
				opath="/data/RDF_Processing/data_1b/index2/lubm_q8/"+pn.toString()+".R4";
				OutFile=new File(opath);
				...
				//print R5
				opath="/data/RDF_Processing/data_1b/index2/lubm_q8/"+pn.toString()+".R5";
				OutFile=new File(opath);
