	...
	public static def main(args: Array[String]) {
		...
		finish for( p in Place.places()){
			at (p) async {
				...
				//add R2 <?a 17528 20871>
				keyString=17528.toString()+20871.toString();
				tmpoNode=new poNode(keyString);
				for(i in 0..(N-1)){
		...
		finish for( p in Place.places()){
			at (p) async {
				...
				//print R1
				var opath:String="/data/RDF_Processing/data_1b/index2/lubm_q5/"+pn.toString()+".R1";
				...
				//print R2
				opath="/data/RDF_Processing/data_1b/index2/lubm_q5/"+pn.toString()+".R2";
