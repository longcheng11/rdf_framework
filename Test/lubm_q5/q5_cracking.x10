	...
	public static def main(args: Array[String]) {
		...
		finish for( p in Place.places()){
			at (p) async {
				...
				var ns:String;
				val s2="/data/RDF_Processing/data_1b/index2/lubm_q5/"+pn.toString()+".R1.gz";
				...
				//build for R2 <?a 17528 20871>
				val s3="/data/RDF_Processing/data_1b/index2/lubm_q5/"+pn.toString()+".R2.gz";
				lstring=gzRead(s3);
				len=lstring.length();
				start=0;
				end=0;
		...
		finish for( p in Place.places()){
			at (p) async {
				...
				//build R2 hash set <?a 17528 20871>
				var R0_Node:poNode;
				var R0_tuple:ArrayList[Long];
				var postring:String=17528.toString()+20871.toString();				
